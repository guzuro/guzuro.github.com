...
/*!*******************************!*\
  ...
  \*******************************/
/*! exports provided: IsClientGuard, IsDriverGuard, IsWarehouseGuard, IsSupervisorGuard, LoginRedirect, isEmployer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IsClientGuard", function() { return IsClientGuard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IsDriverGuard", function() { return IsDriverGuard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IsWarehouseGuard", function() { return IsWarehouseGuard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IsSupervisorGuard", function() { return IsSupervisorGuard; });
...
class IsClientGuard {
    ...
    canActivate(next, state) {
        if (this.authService.isAuth && this.authService.userRole == 'client') {
            return true;
        }
        else {
            this.router.navigate(['/login']);
...
IsClientGuard.ɵfac = function IsClientGuard_Factory(t) { return new (t || IsClientGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"])); };
IsClientGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: IsClientGuard, factory: IsClientGuard.ɵfac });
class IsDriverGuard {
    constructor(authService, router) {
        this.authService = authService;
        this.router = router;
    ...
    canActivate(next, state) {
        if (this.authService.isAuth && this.authService.userRole == 'driver') {
            return true;
        }
        else {
            this.router.navigate(['/login']);
...
IsDriverGuard.ɵfac = function IsDriverGuard_Factory(t) { return new (t || IsDriverGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"])); };
IsDriverGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: IsDriverGuard, factory: IsDriverGuard.ɵfac });
class IsWarehouseGuard {
    constructor(authService, router) {
        this.authService = authService;
        this.router = router;
    }
    canActivate(next, state) {
        if (this.authService.isAuth && this.authService.userRole == 'warehouse') {
            return true;
        }
        else {
            this.router.navigate(['/login']);
...
IsWarehouseGuard.ɵfac = function IsWarehouseGuard_Factory(t) { return new (t || IsWarehouseGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"])); };
IsWarehouseGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: IsWarehouseGuard, factory: IsWarehouseGuard.ɵfac });
class IsSupervisorGuard {
    constructor(authService, router) {
        this.authService = authService;
        this.router = router;
    }
    canActivate(next, state) {
        if (this.authService.isAuth && this.authService.userRole == 'supervisor') {
            return true;
        }
        else {
            this.router.navigate(['/login']);
...
IsSupervisorGuard.ɵfac = function IsSupervisorGuard_Factory(t) { return new (t || IsSupervisorGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"])); };
IsSupervisorGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: IsSupervisorGuard, factory: IsSupervisorGuard.ɵfac });
class LoginRedirect {
    constructor(authService, router) {
        this.authService = authService;
        this.router = router;
    ...
    canActivate(next, state) {
        if (this.authService.isAuth == true && state.url == '/login') {
            this.router.navigate(['/dashboard/' + this.authService.userRole]);
            return false;
        }
        return true;
    }
