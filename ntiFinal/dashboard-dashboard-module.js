...
/* harmony import */ var _account_info_account_info_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./account-info/account-info.component */ "GxF5");
/* harmony import */ var _layout_layout_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./layout/layout.component */ "rlst");
...
const routes = [
    {
        ...
        children: [
            {
                path: 'client',
                loadChildren: () => Promise.all(/*! import() | client-client-module */[__webpack_require__.e("default~client-client-module~driver-driver-module~supervisor-supervisor-module~warehouse-warehouse-module"), __webpack_require__.e("client-client-module")]).then(__webpack_require__.bind(null, /*! ./client/client.module */ "vgq2")).then((m) => m.ClientModule), canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_0__["IsClientGuard"]]
            },
            {
                path: 'driver',
                loadChildren: () => Promise.all(/*! import() | driver-driver-module */[__webpack_require__.e("default~client-client-module~driver-driver-module~supervisor-supervisor-module~warehouse-warehouse-module"), __webpack_require__.e("driver-driver-module")]).then(__webpack_require__.bind(null, /*! ./driver/driver.module */ "z2/N")).then((m) => m.DriverModule), canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_0__["IsDriverGuard"]]
            },
            {
                path: 'warehouse',
                loadChildren: () => Promise.all(/*! import() | warehouse-warehouse-module */[__webpack_require__.e("default~client-client-module~driver-driver-module~supervisor-supervisor-module~warehouse-warehouse-module"), __webpack_require__.e("warehouse-warehouse-module")]).then(__webpack_require__.bind(null, /*! ./warehouse/warehouse.module */ "9OwO")).then((m) => m.WarehouseModule), canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_0__["IsWarehouseGuard"]]
            },
            {
                path: 'supervisor',
                loadChildren: () => Promise.all(/*! import() | supervisor-supervisor-module */[__webpack_require__.e("default~client-client-module~driver-driver-module~supervisor-supervisor-module~warehouse-warehouse-module"), __webpack_require__.e("supervisor-supervisor-module")]).then(__webpack_require__.bind(null, /*! ./supervisor/supervisor.module */ "7Rsk")).then((m) => m.SupervisorModule), canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_0__["IsSupervisorGuard"]]
            },
            { path: 'account-info', component: _account_info_account_info_component__WEBPACK_IMPORTED_MODULE_2__["AccountInfoComponent"] },
        ],
    },
];
class DashboardRoutingModule {
}
DashboardRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineNgModule"]({ type: DashboardRoutingModule });
DashboardRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjector"]({ factory: function DashboardRoutingModule_Factory(t) { return new (t || DashboardRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵsetNgModuleScope"](DashboardRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] }); })();
...
DashboardModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjector"]({ factory: function DashboardModule_Factory(t) { return new (t || DashboardModule)(); }, providers: [
        _auth_guard__WEBPACK_IMPORTED_MODULE_3__["IsClientGuard"],
        _auth_guard__WEBPACK_IMPORTED_MODULE_3__["IsDriverGuard"],
        _auth_guard__WEBPACK_IMPORTED_MODULE_3__["IsWarehouseGuard"],
        _auth_guard__WEBPACK_IMPORTED_MODULE_3__["IsSupervisorGuard"]
    ], imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_0__["DashboardRoutingModule"]]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵsetNgModuleScope"](DashboardModule, { declarations: [_layout_layout_component__WEBPACK_IMPORTED_MODULE_2__["LayoutComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_0__["DashboardRoutingModule"]] }); })();
