...
class OrdersForDriverComponent {
    ...
    getOrders(id) {
        let sub = this.orderService.getOrdersByDriverUid(id).subscribe((order) => {
            this.orders = order;
        });
    }
}
...
OrdersForDriverComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: OrdersForDriverComponent, selectors: [["app-orders-for-driver"]], decls: 4, vars: 2, consts: [[1, "mt-5", "mb-3"], [3, "role", "orders"]], template: function OrdersForDriverComponent_Template(rf, ctx) { if (rf & 1) {
